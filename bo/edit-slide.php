...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE slider SET titleSlider=%s, categorieIdSlider=%s WHERE idSlider=%s",
...
$colname_jx_edit = "-1";
if (isset($_GET['idEdit2'])) {
  $colname_jx_edit = $_GET['idEdit2'];
}
mysql_select_db($database_cn_bwdkadw, $cn_bwdkadw);
$query_jx_edit = sprintf("SELECT * FROM slider WHERE idSlider = %s", GetSQLValueString($colname_jx_edit, "int"));
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table align="center">
    <tr valign="baseline">
      ...
      <td><?php echo $row_jx_edit['idSlider']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap align="right">Titre:</td>
      <td><input type="text" name="title" value="<?php echo htmlentities($row_jx_edit['titleSlider'], ENT_COMPAT, ''); ?>" size="32"></td>
    </tr>
  ...
  <input type="hidden" name="idSlider" value="<?php echo $row_jx_edit['idSlider']; ?>">
</form>
