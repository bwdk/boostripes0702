...
<div class="row-fluid">
<a href="admin.php"><button type="button" class="btn btn-default">Vers Ajout d'articles</button></a> &nbsp; <a href="add-slide.php"><button type="button" class="btn btn-default">Vers Ajout de slides</button></a>
